...
it('lists organizations for the current team', function () {
    ...
    $response->assertStatus(200)
        ...
        ->assertJsonPath('organizations.0.id', $org1->id)
        ->assertJsonPath('organizations.1.id', $org2->id)
        ->assertJsonPath('competitor_count', 1)
        ->assertJsonPath('competitor_limit', 500)
