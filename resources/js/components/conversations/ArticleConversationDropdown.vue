...
const fetchConversations = async () => {
	...
	try {
		...
		// Set the first conversation as active if none selected yet
...
const createNewConversation = async () => {
	...
	try {
		...
		// Dropdown will be closed by setActiveConversation
	} catch (error) {
...
// Watch for articleId changes to refetch conversations
watch(
	() => props.articleId,
	(newId) => {
...
<template>
	<div v-if="props.articleId" ref="dropdownRef" class="relative mb-4">
		<!-- Dropdown Trigger -->
		<button
			...
			<div class="p-1">
				...
				<div v-else class="max-h-[240px] overflow-y-auto">
					...
					>
						...
						<!-- Check icon for active conversation -->
						<svg
	...
	<!-- Fallback display when no articleId (static title) -->
