...
const visibility = computed(() => props.organization?.visibility || 0)
const rank = computed(() => props.organization?.visibility_rank || '-')
</script>
	...
	<div class="bg-white rounded-lg p-4 border border-neutral-200 shadow-sm">
		<div class="flex items-center gap-6">
			...
			<div class="w-1/3 flex flex-col items-center p-3 bg-neutral-50 rounded-lg">
				...
				<div class="text-4xl font-medium text-neutral-700">#{{ rank }}</div>
			</div>

			<div class="w-1/3 flex flex-col items-center p-3 bg-neutral-50 rounded-lg">
				<div class="text-sm font-medium text-neutral-500 mb-1">Visibility</div>
				<div class="text-4xl font-medium text-green-600 flex items-start gap-0.5">
					{{ visibility }}
