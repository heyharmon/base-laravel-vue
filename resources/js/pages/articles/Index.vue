    ...
    <div class="container mx-auto py-8">
      ...
      <div v-else>
        <div class="bg-white border border-neutral-200 rounded-xl overflow-hidden">
          ...
          <div v-for="article in articleStore.articles" :key="article.id" class="grid grid-cols-12 gap-4 p-4 border-b border-neutral-100 hover:bg-neutral-50 transition-colors">
            ...
            <div class="col-span-3 text-right flex justify-end gap-2">
              <button 
                ...
                class="text-neutral-500 hover:text-neutral-700 p-1"
                title="Edit"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
              ...
              <button 
                ...
                class="text-neutral-500 hover:text-red-600 p-1"
                title="Delete"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
