    ...
    <DefaultLayout>
        <div class="container mx-auto py-8">
            ...
            <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div v-for="campaign in campaignStore.campaigns" :key="campaign.id" class="bg-white border border-neutral-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
        ...
        <div v-if="showCreateModal" class="fixed inset-0 bg-neutral-300/50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg p-6 w-full max-w-md">
                ...
                <div class="flex justify-end space-x-2">
                    ...
                    <Button @click="createCampaign" :disabled="isSubmitting || !newCampaign.name" variant="dark">{{ isSubmitting ? 'Creating...' : 'Create Campaign' }}</Button>
                </div>
            </div>
        </div>
    </DefaultLayout>
