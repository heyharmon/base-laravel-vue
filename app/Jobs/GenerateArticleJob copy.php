...
class GenerateArticleJob extends TrackableJob
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $systemInstructions = "You are a helpful, knowledgeable assistant that writes structured, question-and-answer style articles to help businesses increase their visibility in LLM completions for specific prompts (e.g., \"best home loan Salt Lake City\").
...
You can use web search to research the businesses website, high-ranking competitors, awards, reviews, relevant stats or proof points and anything else you need to generate the most effective article possible. If you must ask the user any strategic questions then do so.
...
- Do not write code";
            ...
            $userMessage = "Generate a credible, semantic article for {$this->organization->name} ({$this->organization->website}) that will increase our visibility in LLM completions and, most importantly, directly answers this prompt: \"{$this->model->content}\"";
